...
const permittedProperties = new Set(["path", "campaign", "source", "medium", "event_slug", "device_class"]);

export function sanitizePublicAnalyticsProperties(properties: Record<string, unknown>): Record<string, string | number | boolean> {
