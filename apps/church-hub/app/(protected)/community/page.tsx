    ...
    <>
      <PageHeading
        ...
        actions={
          <div className="heading-actions">
            <Link className="hub-button hub-button--primary" href="/fellowship">Create a meetup</Link>
      ...
      <div className="community-layout">
        <aside className="hub-panel channel-list">
          ...
          <Link href="/fellowship">Open fellowship invitations <span>6</span></Link>
          ...
          <div className="channel-rule">
            ...
            <span>Turn a conversation into a prayer walk, meal, playdate, service outing, or public meetup through Fellowship.</span>
          </div>
          <div className="channel-rule">
        ...
        <section id="feed" className="feed">
          <article className="community-connection-banner">
            <div>
              ...
              <p>Open Fellowship to join through the Hub without needing to already have the host’s phone number.</p>
            </div>
            <Link className="hub-button hub-button--light" href="/fellowship">Browse meetups</Link>
          </article>
