  ...
  return (
    <>
      <PageHeading
        eyebrow="Personalized weekly home"
        title="This Week"
        description="What is happening now, what you should know, and the next useful action."
        actions={<Link className="hub-button hub-button--secondary" href="/notifications">Notification settings</Link>}
      />
      ...
      <div className="dashboard-grid">
        <section className="hub-panel hub-panel--span2">
          <div className="panel-heading">
            <div><p className="hub-kicker">Current lesson · {d.lesson.series}</p><h2>{d.lesson.title}</h2></div>
            <span className="pill">{d.lesson.scripture}</span>
          </div>
          <p>{d.lesson.summary}</p>
          <div className="row-actions">
            <Link className="hub-button hub-button--primary" href="/bible">Open lesson</Link>
            <button className="hub-button hub-button--secondary">Save for group</button>
          </div>
        </section>
        <section className="hub-panel">
          ...
          <Link href="/bible">Open licensed reader →</Link>
        </section>
        <section className="hub-panel">
