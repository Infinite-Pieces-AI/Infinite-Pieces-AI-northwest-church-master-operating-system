...
export const thisWeekData: ThisWeekData = {
  ...
  lesson: {
    ...
    summary:
      "Begin the whole-Bible journey with creation, human dignity, purpose, relationship, and the God who brings order, life, and belonging.",
  },
  scriptureOfWeek: {
...
export const fellowshipMeetups: FellowshipMeetup[] = [
  {
    ...
    description:
      "We are bringing the kids for an easy walk, a short prayer for the city, and time to catch up. Strollers and last-minute joins are welcome.",
    audience: "Everyone",
    attendeeCount: 6,
    capacity: 18,
    familyFriendly: true,
    ...
    tags: ["Prayer", "Kids welcome", "Outdoors"],
  },
  {
    id: "meetup-2",
    ...
    area: "Lowell",
    description:
      "A low-pressure playdate for children and a chance for parents to build friendships. Bring snacks, blankets, or simply show up.",
    audience: "Parents and guardians",
    attendeeCount: 11,
    capacity: 30,
    familyFriendly: true,
    tags: ["Playdate", "Families", "Come and go"],
  },
  {
    id: "meetup-3",
    ...
    area: "Central Lowell",
    description:
      "An open table for anyone who wants company, conversation, and one question from this week's Genesis lesson. No preparation needed.",
    audience: "Adults and young adults",
    attendeeCount: 8,
    capacity: 14,
    familyFriendly: false,
    exactLocationAfterJoin: true,
    tags: ["Coffee", "Bible", "Conversation"],
  },
  {
    id: "meetup-4",
    ...
    area: "Lowell",
    description:
      "Help assemble care supplies, pray together, and meet members from across family groups. Tasks are available for multiple ages and abilities.",
    audience: "Whole church",
    attendeeCount: 23,
    capacity: 60,
    familyFriendly: true,
    tags: ["Service", "Whole church", "Accessible"],
  },
  {
    id: "meetup-5",
    ...
    description:
      "Casual half-court games, plenty of breaks, and a short prayer huddle at the end. Spectators and beginners are welcome too.",
    audience: "Teens and adults",
    attendeeCount: 12,
    capacity: 24,
    familyFriendly: true,
    exactLocationAfterJoin: true,
    tags: ["Sports", "Teens", "Beginner friendly"],
  },
  {
    id: "meetup-6",
    ...
    area: "Lowell",
    description:
      "Choose a table after service so nobody has to wonder where to go or eat alone. Each table lists the host, price range, family fit, and available seats.",
    audience: "Whole church",
    attendeeCount: 31,
    capacity: 80,
    familyFriendly: true,
    tags: ["Lunch", "New friends", "Whole church"],
  },
];
