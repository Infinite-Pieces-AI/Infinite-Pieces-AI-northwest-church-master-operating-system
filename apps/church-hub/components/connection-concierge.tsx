...
const suggestions = {
  company: {
    ...
    body: "There are open, low-pressure gatherings this week: a family prayer walk, coffee and Scripture, and Sunday lunch tables. You choose what feels manageable; nothing is shared until you join.",
    href: "/fellowship",
  ...
  today: {
    ...
    body: "The family prayer walk is designed for last-minute joins, and the Connection Guide can also help you create a simple coffee, walk, or playground invitation in under a minute.",
    href: "/fellowship",
  ...
  host: {
    ...
    body: "A strong invitation includes a public place, a simple activity, a start and end time, who it fits, and permission to come late or leave early. The Fellowship form drafts this structure for you.",
  ...
  serve: {
    ...
    body: "The supply-packing gathering is open to multiple ages and abilities. Future recommendations can match interests and availability without exposing private prayer, child, or pastoral information.",
    href: "/fellowship",
  ...
  scripture: {
    ...
    body: "Open Genesis 1-2, notice what the passage says about God and human purpose, pray one honest sentence, and choose one relationship where you can practice dignity and care today.",
    href: "/bible",
  ...
  return (
    <section className={`connection-concierge${compact ? " connection-concierge--compact" : ""}`}>
      ...
      <div className="concierge-chips" aria-label="Connection guide options">
        {(
          Object.entries(suggestions) as Array<[SuggestionKey, (typeof suggestions)[SuggestionKey]]>
        ).map(([key, suggestion]) => (
          <button
            key={key}
            type="button"
      ...
      {!compact ? (
        <p className="connection-boundary">
          This guide supports connection; it is not emergency, clinical, legal, or
          mandatory-reporting support. Urgent safety concerns must follow the church’s approved
          escalation process.
        </p>
      ) : null}
    </section>
