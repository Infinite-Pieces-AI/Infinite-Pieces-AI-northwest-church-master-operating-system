      ...
      <aside className="os-sidebar">
        ...
        <div className="source-boundary">
          ...
          <div>
            ...
            <p>Aggregate search data and publicly available discussions only. No private-group crawling or individual religious profiling.</p>
          </div>
        </div>
      </aside>
      <div className="os-main">
        <header className="os-topbar">
          <div className="topbar-status">
            <span><i className="status-dot status-dot--demo" />Demo intelligence</span>
            <span><i className="status-dot status-dot--safe" />Human approval required</span>
          </div>
          <div className="topbar-actions">
            ...
            <div className="viewer-chip">
              ...
              <div><strong>{viewer.displayName}</strong><small>{viewer.demo ? "Synthetic demo operator" : viewer.email}</small></div>
            </div>
          </div>
        </header>
        {viewer.demo ? (
          <div className="demo-rail">
            <strong>Synthetic demo:</strong> opportunities, traffic, people, rankings, sources, and campaign results shown here are fictional until approved integrations are connected.
          </div>
        ) : null}
