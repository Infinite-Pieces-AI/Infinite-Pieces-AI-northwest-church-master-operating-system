    ...
    <>
      ...
      <section className="welcome-strip welcome-strip--autonomy">
        <div className="page-shell">
          <p>
            <strong>You can explore at your own pace.</strong> No account is required to attend,
            watch, ask a question, or learn what Sunday is like.
          </p>
      ...
      <section className="page-section page-section--tint">
        <div className="page-shell">
          ...
          <div className="promise-grid">
            <article>
              <span>01</span>
              <h3>You can seek Jesus here.</h3>
              <p>
                Explore Scripture, teaching, and questions about Jesus without pretending you
                already know the answers.
              </p>
            </article>
            <article>
              <span>02</span>
              <h3>You can ask honestly here.</h3>
              <p>
                Ask about beliefs, the service, Bible study, children, accessibility, or online
                participation.
              </p>
            </article>
            <article>
              <span>03</span>
              <h3>You can form relationships here.</h3>
              <p>
                Sunday worship connects to meals, family groups, Bible conversations, prayer walks,
                and ordinary shared life.
              </p>
            </article>
            <article>
              <span>04</span>
              <h3>You can serve people here.</h3>
              <p>
                Faith becomes practical through approved opportunities to care for neighbors and
                serve beside others.
              </p>
            </article>
          </div>
      ...
      <section className="page-section">
        <div className="page-shell">
          <div className="section-intro">
            ...
            <p>
              Clear information reduces first-visit uncertainty and lets you decide how much you
              want to participate.
            </p>
          </div>
          <div className="sunday-timeline">
            <article>
              <span>Before</span>
              <div>
                <strong>Arrive when you feel ready</strong>
                <p>
                  Many guests prefer arriving 15–20 minutes early for parking, the entrance,
                  seating, and optional Kids Kingdom questions.
                </p>
              </div>
            </article>
            <article>
              ...
              <div>
                <strong>Worship begins</strong>
                <p>
                  Expect prayer, worship, Scripture, teaching, and current announcements. You can
            ...
            <article>
              <span>After</span>
              <div>
                <strong>Stay, talk, or head home</strong>
                <p>
                  Conversation after worship is optional. A welcome volunteer can answer practical
                  questions or introduce you to someone.
                </p>
              </div>
            </article>
          </div>
          <div className="button-row centered-actions">
            <Link className="button button--gold" href="/what-to-expect">
              Read the full first-Sunday guide
            </Link>
            <PublicActionLink
              className="button button--outline-dark"
              href="/api/public/schedule/calendar"
      ...
      <section className="page-section page-section--dark">
        <div className="page-shell">
          <div className="section-intro">
            ...
            <p>
              Approved members use the private Church Hub to create safe, low-pressure ways to spend
              time together.
            </p>
          </div>
          ...
          <p className="privacy-note privacy-note--light">
            Public pages show only general examples and approved public events. Member identities,
            attendee lists, private locations, and meetup conversations remain inside authorized Hub
            workflows.
          </p>
        </div>
      </section>
        ...
        <div className="page-shell">
          ...
          {events.length ? (
            ...
            <div className="empty-public-state">
              <h3>See the current Sunday gathering</h3>
              <p>
                Public events appear only after a leader approves the date, location, audience, and
      ...
      <section className="page-section page-section--dark">
        <div className="page-shell split split--reverse">
          ...
          <div>
            ...
            <p>
              Explore current public events, approved community involvement, and ways to begin
              serving beside other people without treating service as a membership requirement.
            </p>
            <Link className="text-cta" href="/serve-lowell">
              Explore service in Lowell →
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="cta-band choice-cta-band">
        <div className="page-shell">
          <div className="section-intro">
            <p className="eyebrow">Choose the next step that fits</p>
            <h2>You do not have to submit a form to begin.</h2>
          </div>
          <div className="choice-grid">
            <PublicActionLink
              ...
              properties={{ path: "/" }}
            >
              <strong>Just get directions</strong>
              <span>Open the current meeting location.</span>
            </PublicActionLink>
            <Link className="choice-card" href="/plan-a-visit">
              <strong>Tell someone I’m coming</strong>
              <span>Request practical first-visit help.</span>
            </Link>
            <Link className="choice-card" href="/ask-a-question">
              <strong>Ask a question</strong>
              <span>Choose the topic and contact method.</span>
            </Link>
            <Link className="choice-card" href="/online-bible-study">
              <strong>Explore an online option</strong>
              <span>Request an approved conversation from home.</span>
            </Link>
            <Link className="choice-card" href="/request-prayer">
              <strong>Request prayer privately</strong>
              <span>Use a separate restricted workflow.</span>
            </Link>
          </div>
        </div>
      </section>
